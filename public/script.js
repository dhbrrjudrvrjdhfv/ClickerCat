...
async function updateEverything() {
  try {
    ...
    // AUTHORITATIVE VALUES — everyone ends up here
    ...
    // PERFECT TIMER — server-calculated
    const secondsLeft = time.secondsLeft;
    ...
    // Reset optimistic counter — server is truth
    optimisticClicks = 0;
  } catch (e) {}
}
